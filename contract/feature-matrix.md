...
| Webリンクプレビュー（OGP等） | ✅ | ✅ | ✅ | 表示モデル・カードUIはpackage、metadata取得と先頭URLの画像1枚の代理保存はapp |
...
| 空状態 | ✅ | ✅ | ✅ | 共通の表示契約 |
| リプライ | ✅ | 📝 | 📝 | packageは軽量返信参照・選択・引用表示、appは保存・権限・対象取得を担当。共通interfaceは`reply-message-contract.md` |
